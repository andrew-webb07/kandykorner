...
export const EmployeeForm = () => {
    ...
    return (
      <form className="employeeForm">
        ...
        <fieldset>
          <div className="form-group">
            <label htmlFor="employeeManager">Is a Manager?</label>
            <input type="checkbox" id="employeeManager" name="employeeManager" checked={employee.isManager} required autoFocus className="form-control"
        ...
        <fieldset>
          <div className="form-group">
            <label htmlFor="employeeFullTime">Is full-time?</label>
            <input type="checkbox" id="employeeFullTime" name="employeeFullTime" checked={employee.isFullTime} required autoFocus className="form-control"
            placeholder="Employee Manager"
        ...
        <fieldset>
          <div className="form-group">
            ...
            <input type="number" id="employeeHourlyRate" name="hourlyRate" required autoFocus className="form-control"
